...
def generate_launch_description():
    ...
    roas_path = LaunchConfiguration('roas_path')
    ...
    arg_roas_path = DeclareLaunchArgument(
        'roas_path',
        default_value='/home/jackal/colcon_ws/src/roas2_bringup/'
    )
    ...
    robot_urdf = PathJoinSubstitution([
        roas_path, 'urdf/roas2.urdf.xacro'])
